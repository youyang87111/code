...
@Service
public class LmerTimerTask {
	
	@Resource
	private LmerTimerTaskHandler	lmerTimerTaskHandler;
	...
	public void execute() {
		...
		try {
			...
			lmerTimerTaskHandler.processMerFile(date, fileNames, ftp_directory, vector);
