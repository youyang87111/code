...
public class BaseAjaxController {
	...
	public JSONObject makeSuccessJson(Object msg) {
		...
		json.put("msg",
			(TranslationUtils
				.getInstance(com.pax.common.util.WebUtils.getSession() == null ? null
					: (Locale) com.pax.common.util.WebUtils.getSession().getAttribute("locale"))
				.__((String) msg)));
		return json;
	}
	...
	public JSONObject makeDataTableJSON(	String sEcho, long count,JSONArray jsonArray) {
