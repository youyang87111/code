...
<div class="box">
    <div class="box-body">
        ...
        <table id="selCposMer_dt1" class="table table-bordered table-hover pax-datatable-cls">
            <thead>
            <tr>
                <th width="20px">
...
<script src="${ctx}/js/busi/resourceMgr/selCposMer2.js" type="text/javascript"></script>