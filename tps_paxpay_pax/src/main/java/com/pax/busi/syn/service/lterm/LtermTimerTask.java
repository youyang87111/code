...
@Service
public class LtermTimerTask {
	
	@Resource
	private LtermTimerTaskHandler	ltermTimerTaskHandler;
	...
	public void execute() {
		...
		try {
			...
			ltermTimerTaskHandler.processTermFile(date, fileNames, ftp_directory, vector);
