...
public class MapTimerTask {
	...
	@Resource
	private MapTimerTaskHandler	bindShipTimerTaskHandler;
	...
	public void execute() {
		...
		logger.info("开始执行读取门店开通的渠道信息文件的定时任务");
		...
		try {
			...
			bindShipTimerTaskHandler.processBankFile(fileNames, ftp_directory, vector);
