    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title i18n-flag" i18n-data="join_report"></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <form class="search-form" for-table="cposhistransTable" before-search="beforeSearch('transdateb_s','transdatee_s','amountb_s','amounte_s')">
                    <div style="">
                        <div class="row">
                            ...
                            <div class="col-md-4 pad-left">
                                <div class="input-group col-md-12">
                                    ...
                                    <span class="input-group-addon i18n-flag"
                                          i18n-data="error_data_in_merch_no_access"></span>
                                    </div>
                                    <div class="col-md-6 data-list-sty">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 pad-left">
                                <div class="input-group col-md-12">
                                    <div class="col-md-6">
                                    <span class="input-group-addon i18n-flag"
                                          i18n-data="errordata_export_terminal_no"></span>
                                    </div>
                                    <div class="col-md-6 data-list-sty">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 pad-left">
                                <div class="input-group col-md-12">
                                    ...
                                    <div class="col-md-6 data-list-sty">
                                        <input id="cposhistransOrgId" name="orgId" class="form-control input-sm" name="orgId"
                                               style="display: none">
                                        <span>
										<button type="button" id="cposhistransOrgBtn"
										...
										<ul class="dropdown-menu">
											<li>
												<ul id="cposhistransOrgTree" class="ztree"
                        ...
                        <div class="row">
                            <div class="col-md-4 pad-left">
                                <div class="input-group col-md-12">
                                    <div class="col-md-6">
                                    <span class="input-group-addon i18n-flag" i18n-data="trade_money_range"
                                          style="line-height:58px;"></span>
                                    </div>
                                    <div class="col-md-6 data-list-sty">
                                        <input id="amountb_s" class="form-control input-sm" maxlength="10" name="amountb"><input
                                            id="amounte_s" class="form-control input-sm" maxlength="10" name="amounte">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 pad-left">
                                <div class="input-group col-md-12">
                                    <div class="col-md-6">
                                    <span class="input-group-addon i18n-flag" i18n-data="trade_date_range"
                                          style="line-height:58px;"></span>
                                    </div>
                                    <div class="col-md-6 data-list-sty">
                                        <input id="transdateb_s" readonly="readonly" class="form-control input-sm" name="transdateb"
                                               maxlength="7" data-date-end-date="0d"><input id="transdatee_s" name="transdatee"
                                                                                             readonly="readonly"
                    ...
                    <div style="padding: 5px;border-bottom: 1px solid #F4F4F4;">
                        ...
                        <div class="btn-group" id="myBtnBox">
							...
							<shiro:hasPermission name="cposhistrans:export">
	                            <button id="export" class="btn btn-primary btn-sm rkibtn_export export" type="button"><i
	                                    class="glyphicon glyphicon-export"></i><span class="i18n-flag" i18n-data="main_export">导出</span>
	                            </button>
							</shiro:hasPermission>
                        </div><!-- /.btn-group -->
                    </div>
                ...
                <table id="cposhistransTable" class="table table-bordered table-hover pax-datatable-cls ajax-table" autoload data-action="/cposhistrans/list" optionfn="cposhistransTableOption">
                    <thead>
                    <tr>
                        <th width="100px" class="i18n-flag" i18n-data="trade_system_id"></th>
                        <th width="100px" class="i18n-flag" i18n-data="branch_in_channel"></th>
                        <th width="100px" class="i18n-flag" i18n-data="error_data_in_merch_no_access"></th>
                        ...
                        <th width="100px" class="i18n-flag" i18n-data="money_else"></th>
                        <th width="100px" class="i18n-flag" i18n-data="main_batch_num"></th>
                        <th width="100px" class="i18n-flag" i18n-data="main_flow_num"></th>
                        ...
                        <%--<th width="150px" class="i18n-flag" i18n-data="error_data_deal_day">交易日期</th>--%>
                        <th width="120px" class="i18n-flag" i18n-data="cp_deal_time"></th>
                        <th width="80px" class="i18n-flag" i18n-data="organization_message"></th>
                        <th width="100px" class="i18n-flag" i18n-data="branch_out_channel"></th>
                        <th width="150px" class="i18n-flag" i18n-data="error_data_out_merch_no"></th>
                        <th width="150px" class="i18n-flag" i18n-data="error_data_out_terminal"></th>
                        <th width="120px" class="i18n-flag" i18n-data="cp_cancel_mark"></th>
...
<script src="${ctx}/js/busi/transReport/cposhistrans.js" type="text/javascript"></script>
...
notReset();
    ...
    function cposhistransTableOption(){
        return {
            "aoColumns": [
...
//                {"mDataProp": "transtime","sClass":"center"},
                ...
                {"mDataProp": "voidflag","sClass":"center","fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).text(_T(sData));
                }}
            ]
        }
