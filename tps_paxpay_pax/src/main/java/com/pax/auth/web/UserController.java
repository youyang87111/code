...
public class UserController extends BaseAjaxController {
	...
	public String main(String kickout, Model model) {
		...
		if (subject.isAuthenticated()) {
			model.addAttribute("username", WebUtils.getUserName());
			model.addAttribute("webtitle", translation.__(WebUtils.getUser().getSite().getName()));
			model.addAttribute("orgname", translation.__(WebUtils.getUser().getOrg().getName()));
			return "main";
		} else {
