...
public class WebUtils {
	...
	public static JSONObject makeSuccessFastObj(String msg, Object data) {
		JSONObject json = new JSONObject();
		Locale locale = WebUtils.getSession() == null ? null
			: (Locale) WebUtils.getSession().getAttribute("locale");
		json.put("success", "true");
	...
	public static JSONObject makeSuccessFastObj(String msg) {
		JSONObject json = new JSONObject();
		Locale locale = WebUtils.getSession() == null ? null
			: (Locale) WebUtils.getSession().getAttribute("locale");
	...
	public static JSONObject makeFailedFastObj(String msg) {
		JSONObject json = new JSONObject();
		Locale locale = WebUtils.getSession() == null ? null
			: (Locale) WebUtils.getSession().getAttribute("locale");
