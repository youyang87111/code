package com.pax.core.common.interceptors;
...
@Intercepts({	@Signature(type = Executor.class, method = "update", args = {	MappedStatement.class,
				...
				@Signature(type = Executor.class, method = "query", args = {	MappedStatement.class,
																				...
																				RowBounds.class,
																				ResultHandler.class }) })
public class PaxMybatisInterceptor implements Interceptor {
	
	private static final Logger logger = LoggerFactory.getLogger(PaxMybatisInterceptor.class);
